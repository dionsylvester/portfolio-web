...
const ShortDesc = () => {
    ...
    <>
        <div className='parallax-scroll' ref={ref}>
            <motion.p style={{ y: textY }} className='text-description'>
                Final year Computer Science Student at Bina Nusantara University —{" "}
                
                <EncryptedText 
                    text="Developing digital products through code, story, and passion."
                    encryptedClassName="encrypted-chars"
                    revealedClassName="revealed-chars"
                    revealDelayMs={50}
                />
            </motion.p>
